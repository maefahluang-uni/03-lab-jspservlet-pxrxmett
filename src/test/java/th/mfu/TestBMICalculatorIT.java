...
public class TestBMICalculatorIT {
    ...
    @Test
    public void testCaclulate() {

        // Make a HTTP GET request to retrieve the last created Parolee.
        try (Response response = client.target(WEB_URI+"?weight=67&height=1.8").request().get()) {
            ...
            String jsonResponse = response.readEntity(String.class);
            assertThat(jsonResponse, CoreMatchers.containsString("Result is 21"));
